...
[Lorenz curve](https://demonstrations.wolfram.com/TheLorenzCurve/) macros to assess how concentrated certain data are.  Originally designed to measure wealth concentration across the population, this measure can easily be applied to other data such as sales.
...
# Macros
## compare_relations ([source](macros/get_lorenz.sql))
This macro generates SQL that will compute the Lorenz curve for the specified field.  An optional group_by 
parameter controls the x-axis variable
